...
過去に再現した方向反応率を、そのまま売買ruleとして扱いません。また、支持されなかった無条件タッチ仮説を、使用済みH1/H2標本の条件調整で救済しません。今後の研究資源は、結果を見る前に固定できる実質的に別の仮説、または独立に検証できるexecution・data-path上の問いへ回します。2018年の手動取得経路も、この研究線を維持するための必須作業とは扱いません。
